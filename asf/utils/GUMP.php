...
{	
		...
		foreach($ruleset as $field => $rules)
		{
			...
			foreach($rules as $rule)
			{
				...
				if(is_callable(array($this, $method)))
				{
					...
					{
                                            $result['message'] = strip_tags($this->getReadableMessageForError($result));
                                            $this->errors[] = $result;
					}
				}
				else
	...
	public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-message")
	{
		...
		foreach($this->errors as $e) {
                        $r = $this->getReadableMessageForError($e, $field_class, $error_class);
                        if($r !== false) {
                            $resp[] = $r;
                        }
		}		
        ...
        private function getReadableMessageForError(array $e, $field_class="field", $error_class="error-message") {
